...
MAX_DOC_LEN              = 512 #512 or 2048

P_ALIGN = 1
P_START = 1
P_END   = 1536  # cut x at 2048 or 1536
...
ax.set_title("Pythia 70M: 264 docs used per checkpoint")
...
plt.tight_layout()
plt.savefig(
    "D:/Sync/Sync/ETH Stuff/Bachelor Thesis/Code/graphs/delta_nll_vs_Pd_log2_70M_checkpoints.pdf",
    format="pdf",
    bbox_inches="tight",
)
plt.show()
