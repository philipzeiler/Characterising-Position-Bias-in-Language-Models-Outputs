...
QUICKSTART_FROM = 135          # if code was interrupted, restart by entering how many files you already have
DEDUPED = False
...
for REVISION in REVISIONS:
    ...
    model = GPTNeoXForCausalLM.from_pretrained(
                MODEL_ID, revision=REVISION, torch_dtype=torch.float16 #set to bfloat16 for 1B model, leave as float16 for all others
            ).to(dev).eval()
